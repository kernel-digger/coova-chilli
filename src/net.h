...
int net_init(net_interface * netif, char *ifname, uint16_t protocol,
	     int promisc, uint8_t * mac);
...
ssize_t net_read_dispatch_eth(net_interface * netif, net_handler func,
			      void *ctx);
