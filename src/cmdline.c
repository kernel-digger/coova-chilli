...
typedef enum { ARG_NO, ARG_FLAG, ARG_STRING, ARG_INT, ARG_LONG
...
static void cmdline_parser_release(struct gengetopt_args_info *args_info)
{
	...
	free_multiple_string_field(args_info->proxylocattr_given,
				   &(args_info->proxylocattr_arg),
				   &(args_info->proxylocattr_orig));
	free_string_field(&(args_info->dhcpif_arg));
	free_string_field(&(args_info->dhcpif_orig));
	free_multiple_string_field(args_info->moreif_given,
				   &(args_info->moreif_arg),
				   &(args_info->moreif_orig));
	...
	free_multiple_string_field(args_info->uamallowed_given,
				   &(args_info->uamallowed_arg),
				   &(args_info->uamallowed_orig));
	free_multiple_string_field(args_info->uamdomain_given,
				   &(args_info->uamdomain_arg),
				   &(args_info->uamdomain_orig));
	free_string_field(&(args_info->uamdomainttl_orig));
	free_multiple_string_field(args_info->uamregex_given,
				   &(args_info->uamregex_arg),
				   &(args_info->uamregex_orig));
	...
	free_multiple_string_field(args_info->macallowed_given,
				   &(args_info->macallowed_arg),
				   &(args_info->macallowed_orig));
	...
	free_multiple_string_field(args_info->module_given,
				   &(args_info->module_arg),
				   &(args_info->module_orig));
	free_multiple_string_field(args_info->dhcpopt_given,
				   &(args_info->dhcpopt_arg),
				   &(args_info->dhcpopt_orig));
	free_multiple_string_field(args_info->extadmvsa_given,
				   &(args_info->extadmvsa_arg),
				   &(args_info->extadmvsa_orig));
...
int cmdline_parser_dump(FILE * outfile, struct gengetopt_args_info *args_info)
{
	...
	if (args_info->debugfacility_given)
		write_into_file(outfile, "debugfacility",
				args_info->debugfacility_orig, 0);
	if (args_info->logfacility_given)
		write_into_file(outfile, "logfacility",
	...
	if (args_info->interval_given)
		write_into_file(outfile, "interval", args_info->interval_orig,
				0);
	...
	if (args_info->dhcpstart_given)
		write_into_file(outfile, "dhcpstart", args_info->dhcpstart_orig,
				0);
	...
	if (args_info->uamanyipex_given)
		write_into_file(outfile, "uamanyipex",
				args_info->uamanyipex_orig, 0);
	if (args_info->uamnatanyipex_given)
		write_into_file(outfile, "uamnatanyipex",
				args_info->uamnatanyipex_orig, 0);
	...
	if (args_info->vlanupdate_given)
		write_into_file(outfile, "vlanupdate",
				args_info->vlanupdate_orig, 0);
	if (args_info->vlanlocation_given)
		write_into_file(outfile, "vlanlocation", 0, 0);
	if (args_info->locationupdate_given)
		write_into_file(outfile, "locationupdate",
				args_info->locationupdate_orig, 0);
	...
	if (args_info->autostatip_given)
		write_into_file(outfile, "autostatip",
				args_info->autostatip_orig, 0);
	if (args_info->ringsize_given)
		write_into_file(outfile, "ringsize", args_info->ringsize_orig,
				0);
	...
	if (args_info->childmax_given)
		write_into_file(outfile, "childmax", args_info->childmax_orig,
				0);
	...
	if (args_info->proxylisten_given)
		write_into_file(outfile, "proxylisten",
	...
	if (args_info->proxyclient_given)
		write_into_file(outfile, "proxyclient",
				args_info->proxyclient_orig, 0);
	if (args_info->proxysecret_given)
		write_into_file(outfile, "proxysecret",
	...
	write_multiple_into_file(outfile, args_info->proxylocattr_given,
				 "proxylocattr", args_info->proxylocattr_orig,
				 0);
	if (args_info->dhcpif_given)
		write_into_file(outfile, "dhcpif", args_info->dhcpif_orig, 0);
	write_multiple_into_file(outfile, args_info->moreif_given, "moreif",
				 args_info->moreif_orig, 0);
	...
	if (args_info->dhcpgateway_given)
		write_into_file(outfile, "dhcpgateway",
				args_info->dhcpgateway_orig, 0);
	if (args_info->dhcpgatewayport_given)
		write_into_file(outfile, "dhcpgatewayport",
				args_info->dhcpgatewayport_orig, 0);
	if (args_info->dhcprelayagent_given)
		write_into_file(outfile, "dhcprelayagent",
				args_info->dhcprelayagent_orig, 0);
	if (args_info->lease_given)
		write_into_file(outfile, "lease", args_info->lease_orig, 0);
	if (args_info->leaseplus_given)
		write_into_file(outfile, "leaseplus", args_info->leaseplus_orig,
				0);
	...
	if (args_info->uamserver_given)
		write_into_file(outfile, "uamserver", args_info->uamserver_orig,
				0);
	if (args_info->uamhomepage_given)
		write_into_file(outfile, "uamhomepage",
				args_info->uamhomepage_orig, 0);
	if (args_info->uamsecret_given)
		write_into_file(outfile, "uamsecret", args_info->uamsecret_orig,
				0);
	if (args_info->uamlisten_given)
		write_into_file(outfile, "uamlisten", args_info->uamlisten_orig,
				0);
	if (args_info->dhcplisten_given)
		write_into_file(outfile, "dhcplisten",
				args_info->dhcplisten_orig, 0);
	if (args_info->uamport_given)
		write_into_file(outfile, "uamport", args_info->uamport_orig, 0);
	if (args_info->uamuiport_given)
		write_into_file(outfile, "uamuiport", args_info->uamuiport_orig,
				0);
	write_multiple_into_file(outfile, args_info->uamallowed_given,
				 "uamallowed", args_info->uamallowed_orig, 0);
	write_multiple_into_file(outfile, args_info->uamdomain_given,
				 "uamdomain", args_info->uamdomain_orig, 0);
	if (args_info->uamdomainttl_given)
		write_into_file(outfile, "uamdomainttl",
				args_info->uamdomainttl_orig, 0);
	write_multiple_into_file(outfile, args_info->uamregex_given, "uamregex",
				 args_info->uamregex_orig, 0);
	...
	if (args_info->wisprlogin_given)
		write_into_file(outfile, "wisprlogin",
	...
	if (args_info->uamlogoutip_given)
		write_into_file(outfile, "uamlogoutip",
				args_info->uamlogoutip_orig, 0);
	if (args_info->uamaliasip_given)
		write_into_file(outfile, "uamaliasip",
				args_info->uamaliasip_orig, 0);
	if (args_info->uamaliasname_given)
		write_into_file(outfile, "uamaliasname",
				args_info->uamaliasname_orig, 0);
	if (args_info->uamhostname_given)
		write_into_file(outfile, "uamhostname",
				args_info->uamhostname_orig, 0);
	if (args_info->uamaaaurl_given)
		write_into_file(outfile, "uamaaaurl", args_info->uamaaaurl_orig,
				0);
	...
	if (args_info->defsessiontimeout_given)
		write_into_file(outfile, "defsessiontimeout",
				args_info->defsessiontimeout_orig, 0);
	if (args_info->defidletimeout_given)
		write_into_file(outfile, "defidletimeout",
				args_info->defidletimeout_orig, 0);
	if (args_info->defbandwidthmaxdown_given)
		write_into_file(outfile, "defbandwidthmaxdown",
				args_info->defbandwidthmaxdown_orig, 0);
	if (args_info->defbandwidthmaxup_given)
		write_into_file(outfile, "defbandwidthmaxup",
				args_info->defbandwidthmaxup_orig, 0);
	if (args_info->definteriminterval_given)
		write_into_file(outfile, "definteriminterval",
				args_info->definteriminterval_orig, 0);
	if (args_info->bwbucketupsize_given)
		write_into_file(outfile, "bwbucketupsize",
				args_info->bwbucketupsize_orig, 0);
	if (args_info->bwbucketdnsize_given)
		write_into_file(outfile, "bwbucketdnsize",
				args_info->bwbucketdnsize_orig, 0);
	if (args_info->bwbucketminsize_given)
		write_into_file(outfile, "bwbucketminsize",
				args_info->bwbucketminsize_orig, 0);
	...
	write_multiple_into_file(outfile, args_info->macallowed_given,
				 "macallowed", args_info->macallowed_orig, 0);
	if (args_info->macsuffix_given)
		write_into_file(outfile, "macsuffix", args_info->macsuffix_orig,
				0);
	if (args_info->macpasswd_given)
		write_into_file(outfile, "macpasswd", args_info->macpasswd_orig,
				0);
	...
	if (args_info->adminuser_given)
		write_into_file(outfile, "adminuser", args_info->adminuser_orig,
				0);
	if (args_info->adminpasswd_given)
		write_into_file(outfile, "adminpasswd",
				args_info->adminpasswd_orig, 0);
	if (args_info->adminupdatefile_given)
		write_into_file(outfile, "adminupdatefile",
				args_info->adminupdatefile_orig, 0);
	if (args_info->rtmonfile_given)
		write_into_file(outfile, "rtmonfile", args_info->rtmonfile_orig,
				0);
	...
	if (args_info->cmdsocket_given)
		write_into_file(outfile, "cmdsocket", args_info->cmdsocket_orig,
				0);
	if (args_info->cmdsocketport_given)
		write_into_file(outfile, "cmdsocketport",
				args_info->cmdsocketport_orig, 0);
	...
	if (args_info->maxclients_given)
		write_into_file(outfile, "maxclients",
				args_info->maxclients_orig, 0);
	if (args_info->dhcphashsize_given)
		write_into_file(outfile, "dhcphashsize",
				args_info->dhcphashsize_orig, 0);
	if (args_info->radiusqsize_given)
		write_into_file(outfile, "radiusqsize",
				args_info->radiusqsize_orig, 0);
	if (args_info->challengetimeout_given)
		write_into_file(outfile, "challengetimeout",
				args_info->challengetimeout_orig, 0);
	if (args_info->challengetimeout2_given)
		write_into_file(outfile, "challengetimeout2",
				args_info->challengetimeout2_orig, 0);
	...
	if (args_info->injectext_given)
		write_into_file(outfile, "injectext", args_info->injectext_orig,
				0);
	...
	if (args_info->sslkeyfile_given)
		write_into_file(outfile, "sslkeyfile",
				args_info->sslkeyfile_orig, 0);
	if (args_info->sslkeypass_given)
		write_into_file(outfile, "sslkeypass",
				args_info->sslkeypass_orig, 0);
	if (args_info->sslcertfile_given)
		write_into_file(outfile, "sslcertfile",
				args_info->sslcertfile_orig, 0);
	if (args_info->sslcafile_given)
		write_into_file(outfile, "sslcafile", args_info->sslcafile_orig,
				0);
	...
	if (args_info->ipwhitelist_given)
		write_into_file(outfile, "ipwhitelist",
				args_info->ipwhitelist_orig, 0);
	if (args_info->uamdomainfile_given)
		write_into_file(outfile, "uamdomainfile",
				args_info->uamdomainfile_orig, 0);
	...
	write_multiple_into_file(outfile, args_info->module_given, "module",
				 args_info->module_orig, 0);
	write_multiple_into_file(outfile, args_info->dhcpopt_given, "dhcpopt",
				 args_info->dhcpopt_orig, 0);
	write_multiple_into_file(outfile, args_info->extadmvsa_given,
				 "extadmvsa", args_info->extadmvsa_orig, 0);
...
check_multiple_option_occurrences(const char *prog_name,
				  unsigned int option_given, unsigned int min,
			 ...
			 const char *prog_name, const char *additional_error)
{
	...
	if (check_multiple_option_occurrences
	    (prog_name, args_info->proxylocattr_given,
	     args_info->proxylocattr_min, args_info->proxylocattr_max,
	     "'--proxylocattr'"))
		error = 1;

	if (check_multiple_option_occurrences
	    (prog_name, args_info->moreif_given, args_info->moreif_min,
	     args_info->moreif_max, "'--moreif'"))
		error = 1;

	if (check_multiple_option_occurrences
	    (prog_name, args_info->uamallowed_given, args_info->uamallowed_min,
	     args_info->uamallowed_max, "'--uamallowed'"))
		error = 1;

	if (check_multiple_option_occurrences
	    (prog_name, args_info->uamdomain_given, args_info->uamdomain_min,
	     args_info->uamdomain_max, "'--uamdomain'"))
		error = 1;

	if (check_multiple_option_occurrences
	    (prog_name, args_info->uamregex_given, args_info->uamregex_min,
	     args_info->uamregex_max, "'--uamregex'"))
		error = 1;

	if (check_multiple_option_occurrences
	    (prog_name, args_info->macallowed_given, args_info->macallowed_min,
	     args_info->macallowed_max, "'--macallowed'"))
		error = 1;

	if (check_multiple_option_occurrences
	    (prog_name, args_info->module_given, args_info->module_min,
	     args_info->module_max, "'--module'"))
		error = 1;

	if (check_multiple_option_occurrences
	    (prog_name, args_info->dhcpopt_given, args_info->dhcpopt_min,
	     args_info->dhcpopt_max, "'--dhcpopt'"))
		error = 1;

	if (check_multiple_option_occurrences
	    (prog_name, args_info->extadmvsa_given, args_info->extadmvsa_min,
	     args_info->extadmvsa_max, "'--extadmvsa'"))
		error = 1;
	       ...
	       const char *additional_error)
{
	...
	if (!multiple_option && prev_given
		...
		if (short_opt != '-')
			...
			fprintf(stderr,
				"WARNING %s: `--%s' option given more than once%s\n",
			     ...
			     const char *additional_error)
{
	...
	while (1) {
		...
		if (update_arg((void *)&((*list)->arg), &((*list)->orig), 0,
			       ...
			       default_value, arg_type, 0, 1, 1, 1, long_opt,
			       short_opt, additional_error)) {
			if (multi_token)
				free(multi_token);
			return 1;	/* failure */
		}
	...
	if (prev_given && list) {
		*orig_field =
		...
		case ARG_INT:
			*((int **)field) =
			    (int *)realloc(*((int **)field),
					   (field_given +
					    prev_given) * sizeof(int));
			break;
		case ARG_LONG:
			*((long **)field) =
			    (long *)realloc(*((long **)field),
					    (field_given +
					     prev_given) * sizeof(long));
			break;
		case ARG_STRING:
			*((char ***)field) =
		...
		for (i = (prev_given - 1); i >= 0; --i) {
			...
			switch (arg_type) {
			case ARG_INT:
				(*((int **)field))[i + field_given] =
				    tmp->arg.int_arg;
				break;
			case ARG_LONG:
				(*((long **)field))[i + field_given] =
				    tmp->arg.long_arg;
				break;
			case ARG_STRING:
				(*((char ***)field))[i + field_given] =
				    tmp->arg.string_arg;
				break;
			default:
				break;
			...
			case ARG_STRING:
				if (!*((char ***)field)) {
					*((char ***)field) =
					...
					(*((char ***)field))[0] =
					    gengetopt_strdup(default_value->
							     string_arg);
				}
				break;
			default:
...
struct option {
	...
	int         val;
		...
		*/
		...
		case 'f':	/* Run in foreground.  */
			...
			if (update_arg
			    ((void *)&(args_info->fg_flag), 0,
			     &(args_info->fg_given),
			     &(local_args_info.fg_given), optarg, 0, 0,
			     ARG_FLAG, check_ambiguity, override, 1, 0, "fg",
			     'f', additional_error))
				goto failure;
		...
		case 'b':	/* Binary config file.  */
			...
			if (update_arg((void *)&(args_info->bin_arg),
				       &(args_info->bin_orig),
				       &(args_info->bin_given),
				       &(local_args_info.bin_given), optarg, 0,
				       0, ARG_STRING, check_ambiguity, override,
				       0, 0, "bin", 'b', additional_error))
				goto failure;
		...
		case 'r':	/* Send reload after reconfigure.  */
			...
			if (update_arg
			    ((void *)&(args_info->reload_flag), 0,
			     &(args_info->reload_given),
			     &(local_args_info.reload_given), optarg, 0, 0,
			     ARG_FLAG, check_ambiguity, override, 1, 0,
			     "reload", 'r', additional_error))
				goto failure;
		...
		case 'F':	/* Forgiving of many configuration errors.  */
			...
			if (update_arg
			    ((void *)&(args_info->forgiving_flag), 0,
			     &(args_info->forgiving_given),
			     &(local_args_info.forgiving_given), optarg, 0, 0,
			     ARG_FLAG, check_ambiguity, override, 1, 0,
			     "forgiving", 'F', additional_error))
				goto failure;
		...
		case 'n':	/* Network.  */
			...
			if (update_arg((void *)&(args_info->net_arg),
				       ...
				       "192.168.182.0/24", ARG_STRING,
				       check_ambiguity, override, 0, 0, "net",
				       'n', additional_error))
				goto failure;
		...
		case 0:	/* Long option with no short option */
			...
			if (strcmp
				...
				if (update_arg
				    ((void *)&(args_info->debugfacility_arg),
				     &(args_info->debugfacility_orig),
				     &(args_info->debugfacility_given),
				     &(local_args_info.debugfacility_given),
				     optarg, 0, "1", ARG_INT, check_ambiguity,
				     override, 0, 0, "debugfacility", '-',
				     additional_error))
					goto failure;
			...
			/* Syslog facility to be used for logging.  */
				...
				if (update_arg
				    ((void *)&(args_info->logfacility_arg),
				     &(args_info->logfacility_orig),
				     &(args_info->logfacility_given),
				     &(local_args_info.logfacility_given),
				     optarg, 0, "-1", ARG_INT, check_ambiguity,
				     override, 0, 0, "logfacility", '-',
				     additional_error))
					goto failure;
			...
			/* Re-read configuration file at this interval.  */
				...
				if (update_arg
				    ((void *)&(args_info->interval_arg),
				     &(args_info->interval_orig),
				     &(args_info->interval_given),
				     &(local_args_info.interval_given), optarg,
				     0, "3600", ARG_INT, check_ambiguity,
				     override, 0, 0, "interval", '-',
				     additional_error))
					goto failure;
			...
			else if (strcmp(long_options[option_index].name, "uid")
				 == 0) {

				if (update_arg((void *)&(args_info->uid_arg),
					       &(args_info->uid_orig),
					       &(args_info->uid_given),
					       &(local_args_info.uid_given),
					       optarg, 0, "0", ARG_INT,
					       check_ambiguity, override, 0, 0,
					       "uid", '-', additional_error))
					goto failure;

			}
			/* GID to run as, after being started as root.  */
			else if (strcmp(long_options[option_index].name, "gid")
				 == 0) {

				if (update_arg((void *)&(args_info->gid_arg),
					       &(args_info->gid_orig),
					       &(args_info->gid_given),
					       &(local_args_info.gid_given),
					       optarg, 0, "0", ARG_INT,
					       check_ambiguity, override, 0, 0,
					       "gid", '-', additional_error))
					goto failure;
			...
			/* Network DHCP Starting IP.  */
				...
				if (update_arg
				    ((void *)&(args_info->dhcpstart_arg),
				     &(args_info->dhcpstart_orig),
				     &(args_info->dhcpstart_given),
				     &(local_args_info.dhcpstart_given), optarg,
				     0, "0", ARG_INT, check_ambiguity, override,
				     0, 0, "dhcpstart", '-', additional_error))
					goto failure;
			...
			/* Network DHCP Ending IP.  */
				...
				if (update_arg
				    ((void *)&(args_info->dhcpend_arg),
				     &(args_info->dhcpend_orig),
				     &(args_info->dhcpend_given),
				     &(local_args_info.dhcpend_given), optarg,
				     0, "0", ARG_INT, check_ambiguity, override,
				     0, 0, "dhcpend", '-', additional_error))
					goto failure;
			...
			/* Always broadcast DHCP responses.  */
				...
				if (update_arg
				    ((void *)&(args_info->dhcpbroadcast_flag),
				     0, &(args_info->dhcpbroadcast_given),
				     &(local_args_info.dhcpbroadcast_given),
				     optarg, 0, 0, ARG_FLAG, check_ambiguity,
				     override, 1, 0, "dhcpbroadcast", '-',
				     additional_error))
					goto failure;
			...
			/* Dynamic IP address pool.  */
				...
				if (update_arg((void *)&(args_info->dynip_arg),
					       ...
					       &(args_info->dynip_given),
					       &(local_args_info.dynip_given),
					       optarg, 0, 0, ARG_STRING,
					       check_ambiguity, override, 0, 0,
					       "dynip", '-', additional_error))
					goto failure;
			...
			/* No Dynamic IP assignment.  */
				...
				if (update_arg
				    ((void *)&(args_info->nodynip_flag), 0,
				     &(args_info->nodynip_given),
				     &(local_args_info.nodynip_given), optarg,
				     0, 0, ARG_FLAG, check_ambiguity, override,
				     1, 0, "nodynip", '-', additional_error))
					goto failure;
			...
			/* Static IP address pool.  */
				...
				if (update_arg((void *)&(args_info->statip_arg),
					       ...
					       &(args_info->statip_given),
					       &(local_args_info.statip_given),
					       optarg, 0, 0, ARG_STRING,
					       check_ambiguity, override, 0, 0,
					       "statip", '-', additional_error))
					goto failure;
			...
			/* Network to exclude from uamanyip.  */
				...
				if (update_arg
				    ((void *)&(args_info->uamanyipex_arg),
				     &(args_info->uamanyipex_orig),
				     &(args_info->uamanyipex_given),
				     &(local_args_info.uamanyipex_given),
				     optarg, 0, 0, ARG_STRING, check_ambiguity,
				     override, 0, 0, "uamanyipex", '-',
				     additional_error))
					goto failure;
			...
			/* Network to exclude from uamnatanyip.  */
				...
				if (update_arg
				    ((void *)&(args_info->uamnatanyipex_arg),
				     &(args_info->uamnatanyipex_orig),
				     &(args_info->uamnatanyipex_given),
				     &(local_args_info.uamnatanyipex_given),
				     optarg, 0, 0, ARG_STRING, check_ambiguity,
				     override, 0, 0, "uamnatanyipex", '-',
				     additional_error))
					goto failure;

			}
			/* Primary DNS server IP address.  */
			else if (strcmp(long_options[option_index].name, "dns1")
				 == 0) {

				if (update_arg((void *)&(args_info->dns1_arg),
					       &(args_info->dns1_orig),
					       &(args_info->dns1_given),
					       &(local_args_info.dns1_given),
					       optarg, 0, 0, ARG_STRING,
					       check_ambiguity, override, 0, 0,
					       "dns1", '-', additional_error))
					goto failure;

			}
			/* Secondary DNS server IP address.  */
			else if (strcmp(long_options[option_index].name, "dns2")
				 == 0) {

				if (update_arg((void *)&(args_info->dns2_arg),
					       &(args_info->dns2_orig),
					       &(args_info->dns2_given),
					       &(local_args_info.dns2_given),
					       optarg, 0, 0, ARG_STRING,
					       check_ambiguity, override, 0, 0,
					       "dns2", '-', additional_error))
					goto failure;
			...
			/* Domain to use for DNS lookups.  */
				...
				if (update_arg((void *)&(args_info->domain_arg),
					       &(args_info->domain_orig),
					       &(args_info->domain_given),
					       &(local_args_info.domain_given),
					       optarg, 0, "coova.org",
			...
			/* Script to run after user logon.  */
				...
				if (update_arg((void *)&(args_info->conup_arg),
					       &(args_info->conup_orig),
					       &(args_info->conup_given),
					       &(local_args_info.conup_given),
					       optarg, 0, 0, ARG_STRING,
					       check_ambiguity, override, 0, 0,
					       "conup", '-', additional_error))
					goto failure;
			...
			/* Script to run after user logoff.  */
				...
				if (update_arg
				    ((void *)&(args_info->condown_arg),
				     &(args_info->condown_orig),
				     &(args_info->condown_given),
				     &(local_args_info.condown_given), optarg,
				     0, 0, ARG_STRING, check_ambiguity,
				     override, 0, 0, "condown", '-',
				     additional_error))
					goto failure;
			...
			/* Script to run after initial DHCP.  */
				...
				if (update_arg((void *)&(args_info->macup_arg),
					       &(args_info->macup_orig),
					       &(args_info->macup_given),
					       &(local_args_info.macup_given),
					       optarg, 0, 0, ARG_STRING,
					       check_ambiguity, override, 0, 0,
					       "macup", '-', additional_error))
					goto failure;
			...
			/* Script to run after DHCP release.  */
				...
				if (update_arg
				    ((void *)&(args_info->macdown_arg),
				     &(args_info->macdown_orig),
				     &(args_info->macdown_given),
				     &(local_args_info.macdown_given), optarg,
				     0, 0, ARG_STRING, check_ambiguity,
				     override, 0, 0, "macdown", '-',
				     additional_error))
					goto failure;
			...
			/* Script to run after 802.1Q/VLAN id assignment.  */
				...
				if (update_arg
				    ((void *)&(args_info->vlanupdate_arg),
				     &(args_info->vlanupdate_orig),
				     &(args_info->vlanupdate_given),
				     &(local_args_info.vlanupdate_given),
				     optarg, 0, 0, ARG_STRING, check_ambiguity,
				     override, 0, 0, "vlanupdate", '-',
				     additional_error))
					goto failure;
			...
			/* VLAN is to be used as location.  */
				...
				if (update_arg
				    ((void *)&(args_info->vlanlocation_flag), 0,
				     &(args_info->vlanlocation_given),
				     &(local_args_info.vlanlocation_given),
				     optarg, 0, 0, ARG_FLAG, check_ambiguity,
				     override, 1, 0, "vlanlocation", '-',
				     additional_error))
					goto failure;
			...
			/* Script to run after change of location.  */
				...
				if (update_arg
				    ((void *)&(args_info->locationupdate_arg),
				     &(args_info->locationupdate_orig),
				     &(args_info->locationupdate_given),
				     &(local_args_info.locationupdate_given),
				     optarg, 0, 0, ARG_STRING, check_ambiguity,
				     override, 0, 0, "locationupdate", '-',
				     additional_error))
					goto failure;
			...
			/* Restart the RADIUS accounting stream with new session-id.  */
				...
				if (update_arg
				    ((void *)
				     &(args_info->locationstopstart_flag), 0,
				     &(args_info->locationstopstart_given),
				     &(local_args_info.locationstopstart_given),
				     optarg, 0, 0, ARG_FLAG, check_ambiguity,
				     override, 1, 0, "locationstopstart", '-',
				     additional_error))
					goto failure;
			...
			/* Copy Called-Station-Id from proxy RADIUS.  */
				 ...
				 (long_options[option_index].name,
				  "locationcopycalled") == 0) {

				if (update_arg
				    ((void *)
				     &(args_info->locationcopycalled_flag), 0,
				     &(args_info->locationcopycalled_given),
				     &(local_args_info.
				       locationcopycalled_given), optarg, 0, 0,
				     ARG_FLAG, check_ambiguity, override, 1, 0,
				     "locationcopycalled", '-',
				     additional_error))
					goto failure;
			...
			/* Immediately do an accounting interim update on proxy accounting.  */
				...
				if (update_arg
				    ((void *)
				     ...
				     0,
				     &(args_info->
				       locationimmediateupdate_given),
				     &(local_args_info.
				       locationimmediateupdate_given), optarg,
				     0, 0, ARG_FLAG, check_ambiguity, override,
				     1, 0, "locationimmediateupdate", '-',
				     additional_error))
					goto failure;
			...
			/* Use DHCP Option 82 for location.  */
				...
				if (update_arg
				    ((void *)&(args_info->locationopt82_flag),
				     0, &(args_info->locationopt82_given),
				     &(local_args_info.locationopt82_given),
				     optarg, 0, 0, ARG_FLAG, check_ambiguity,
				     override, 1, 0, "locationopt82", '-',
				     additional_error))
					goto failure;
			...
			/* TX Queue length for tun interface (linux only).  */
				...
				if (update_arg((void *)&(args_info->txqlen_arg),
					       &(args_info->txqlen_orig),
					       &(args_info->txqlen_given),
					       &(local_args_info.txqlen_given),
					       optarg, 0, "100", ARG_INT,
					       check_ambiguity, override, 0, 0,
					       "txqlen", '-', additional_error))
					goto failure;
			...
			/* TUN/TAP Device, as in tun0 or tap1.  */
				...
				if (update_arg((void *)&(args_info->tundev_arg),
					       &(args_info->tundev_orig),
					       &(args_info->tundev_given),
					       &(local_args_info.tundev_given),
					       optarg, 0, 0, ARG_STRING,
					       check_ambiguity, override, 0, 0,
					       "tundev", '-', additional_error))
					goto failure;

			}
			/* MTU given in DHCP.  */
			else if (strcmp(long_options[option_index].name, "mtu")
				 == 0) {

				if (update_arg((void *)&(args_info->mtu_arg),
					       &(args_info->mtu_orig),
					       &(args_info->mtu_given),
					       &(local_args_info.mtu_given),
					       optarg, 0, "1500", ARG_INT,
					       check_ambiguity, override, 0, 0,
					       "mtu", '-', additional_error))
					goto failure;
			...
			/* Auto- static ip assignment.  */
				...
				if (update_arg
				    ((void *)&(args_info->autostatip_arg),
				     &(args_info->autostatip_orig),
				     &(args_info->autostatip_given),
				     &(local_args_info.autostatip_given),
				     optarg, 0, "0", ARG_INT, check_ambiguity,
				     override, 0, 0, "autostatip", '-',
				     additional_error))
					goto failure;
			...
			/* TX/RX Ring Size (in kbytes; linux only).  */
				...
				if (update_arg
				    ((void *)&(args_info->ringsize_arg),
				     &(args_info->ringsize_orig),
				     &(args_info->ringsize_given),
				     &(local_args_info.ringsize_given), optarg,
				     0, "0", ARG_INT, check_ambiguity, override,
				     0, 0, "ringsize", '-', additional_error))
					goto failure;
			...
			/* SNDBUF size (in kb).  */
				...
				if (update_arg((void *)&(args_info->sndbuf_arg),
					       &(args_info->sndbuf_orig),
					       &(args_info->sndbuf_given),
					       &(local_args_info.sndbuf_given),
					       optarg, 0, "0", ARG_INT,
					       check_ambiguity, override, 0, 0,
					       "sndbuf", '-', additional_error))
					goto failure;
			...
			/* RCVBUF size (in kb).  */
				...
				if (update_arg((void *)&(args_info->rcvbuf_arg),
					       &(args_info->rcvbuf_orig),
					       &(args_info->rcvbuf_given),
					       &(local_args_info.rcvbuf_given),
					       optarg, 0, "0", ARG_INT,
					       check_ambiguity, override, 0, 0,
					       "rcvbuf", '-', additional_error))
					goto failure;
			...
			/* Maximum number of child processes.  */
				...
				if (update_arg
				    ((void *)&(args_info->childmax_arg),
				     &(args_info->childmax_orig),
				     &(args_info->childmax_given),
				     &(local_args_info.childmax_given), optarg,
				     0, "128", ARG_INT, check_ambiguity,
				     override, 0, 0, "childmax", '-',
				     additional_error))
					goto failure;
			...
			/* Cluster peer ID.  */
				...
				if (update_arg((void *)&(args_info->peerid_arg),
					       &(args_info->peerid_orig),
					       &(args_info->peerid_given),
					       &(local_args_info.peerid_given),
					       optarg, 0, "0", ARG_INT,
					       check_ambiguity, override, 0, 0,
					       "peerid", '-', additional_error))
					goto failure;
			...
			/* Cluster Blowfish key.  */
				...
				if (update_arg
				    ((void *)&(args_info->peerkey_arg),
				     &(args_info->peerkey_orig),
				     &(args_info->peerkey_given),
				     &(local_args_info.peerkey_given), optarg,
				     0, 0, ARG_STRING, check_ambiguity,
				     override, 0, 0, "peerkey", '-',
				     additional_error))
					goto failure;
			...
			/* IP address to send from.  */
				...
				if (update_arg
				    ((void *)&(args_info->radiuslisten_arg),
				     &(args_info->radiuslisten_orig),
				     &(args_info->radiuslisten_given),
				     &(local_args_info.radiuslisten_given),
				     optarg, 0, 0, ARG_STRING, check_ambiguity,
				     override, 0, 0, "radiuslisten", '-',
				     additional_error))
					goto failure;
			...
			/* IP address of radius server 1.  */
				...
				if (update_arg
				    ((void *)&(args_info->radiusserver1_arg),
				     &(args_info->radiusserver1_orig),
				     &(args_info->radiusserver1_given),
				     &(local_args_info.radiusserver1_given),
				     optarg, 0, 0, ARG_STRING, check_ambiguity,
				     override, 0, 0, "radiusserver1", '-',
				     additional_error))
					goto failure;
			...
			/* IP address of radius server 2.  */
				...
				if (update_arg
				    ((void *)&(args_info->radiusserver2_arg),
				     &(args_info->radiusserver2_orig),
				     &(args_info->radiusserver2_given),
				     &(local_args_info.radiusserver2_given),
				     optarg, 0, 0, ARG_STRING, check_ambiguity,
				     override, 0, 0, "radiusserver2", '-',
				     additional_error))
					goto failure;
			...
			/* Authentication UDP port of radius server.  */
				...
				if (update_arg
				    ((void *)&(args_info->radiusauthport_arg),
				     &(args_info->radiusauthport_orig),
				     &(args_info->radiusauthport_given),
				     &(local_args_info.radiusauthport_given),
				     optarg, 0, "1812", ARG_INT,
				     check_ambiguity, override, 0, 0,
				     "radiusauthport", '-', additional_error))
					goto failure;
			...
			/* Accounting UDP port of radius server.  */
				...
				if (update_arg
				    ((void *)&(args_info->radiusacctport_arg),
				     &(args_info->radiusacctport_orig),
				     &(args_info->radiusacctport_given),
				     &(local_args_info.radiusacctport_given),
				     optarg, 0, "1813", ARG_INT,
				     check_ambiguity, override, 0, 0,
				     "radiusacctport", '-', additional_error))
					goto failure;
			...
			/* Radius shared secret.  */
				...
				if (update_arg
				    ((void *)&(args_info->radiussecret_arg),
				     &(args_info->radiussecret_orig),
				     &(args_info->radiussecret_given),
				     &(local_args_info.radiussecret_given),
				     optarg, 0, "testing123", ARG_STRING,
				     check_ambiguity, override, 0, 0,
				     "radiussecret", '-', additional_error))
					goto failure;
			...
			/* Retry timeout in seconds.  */
				...
				if (update_arg
				    ((void *)&(args_info->radiustimeout_arg),
				     &(args_info->radiustimeout_orig),
				     &(args_info->radiustimeout_given),
				     &(local_args_info.radiustimeout_given),
				     optarg, 0, "10", ARG_INT, check_ambiguity,
				     override, 0, 0, "radiustimeout", '-',
				     additional_error))
					goto failure;
			...
			/* Total number of retries.  */
				...
				if (update_arg
				    ((void *)&(args_info->radiusretry_arg),
				     &(args_info->radiusretry_orig),
				     &(args_info->radiusretry_given),
				     &(local_args_info.radiusretry_given),
				     optarg, 0, "4", ARG_INT, check_ambiguity,
				     override, 0, 0, "radiusretry", '-',
				     additional_error))
					goto failure;
			...
			/* Number of retries before using secondary.  */
				...
				if (update_arg
				    ((void *)&(args_info->radiusretrysec_arg),
				     &(args_info->radiusretrysec_orig),
				     &(args_info->radiusretrysec_given),
				     &(local_args_info.radiusretrysec_given),
				     optarg, 0, "2", ARG_INT, check_ambiguity,
				     override, 0, 0, "radiusretrysec", '-',
				     additional_error))
					goto failure;
			...
			/* Radius NAS-Identifier.  */
				...
				if (update_arg
				    ((void *)&(args_info->radiusnasid_arg),
				     &(args_info->radiusnasid_orig),
				     &(args_info->radiusnasid_given),
				     &(local_args_info.radiusnasid_given),
				     optarg, 0, "nas01", ARG_STRING,
				     check_ambiguity, override, 0, 0,
				     "radiusnasid", '-', additional_error))
					goto failure;
			...
			/* WISPr Location ID.  */
				...
				if (update_arg
				    ((void *)&(args_info->radiuslocationid_arg),
				     &(args_info->radiuslocationid_orig),
				     &(args_info->radiuslocationid_given),
				     &(local_args_info.radiuslocationid_given),
				     optarg, 0, 0, ARG_STRING, check_ambiguity,
				     override, 0, 0, "radiuslocationid", '-',
				     additional_error))
					goto failure;
			...
			/* WISPr Location Name.  */
				 ...
				 (long_options[option_index].name,
				  "radiuslocationname") == 0) {

				if (update_arg
				    ((void *)
				     &(args_info->radiuslocationname_arg),
				     &(args_info->radiuslocationname_orig),
				     &(args_info->radiuslocationname_given),
				     &(local_args_info.
				       radiuslocationname_given), optarg, 0, 0,
				     ARG_STRING, check_ambiguity, override, 0,
				     0, "radiuslocationname", '-',
				     additional_error))
					goto failure;
			...
			/* Location Name.  */
				...
				if (update_arg
				    ((void *)&(args_info->locationname_arg),
				     &(args_info->locationname_orig),
				     &(args_info->locationname_given),
				     &(local_args_info.locationname_given),
				     optarg, 0, 0, ARG_STRING, check_ambiguity,
				     override, 0, 0, "locationname", '-',
				     additional_error))
					goto failure;
			...
			/* Radius NAS-Port-Type.  */
				...
				if (update_arg
				    ((void *)
				     &(args_info->radiusnasporttype_arg),
				     &(args_info->radiusnasporttype_orig),
				     &(args_info->radiusnasporttype_given),
				     &(local_args_info.radiusnasporttype_given),
				     optarg, 0, "19", ARG_INT, check_ambiguity,
				     override, 0, 0, "radiusnasporttype", '-',
				     additional_error))
					goto failure;
			...
			/* Radius disconnect port to listen to.  */
				...
				if (update_arg
				    ((void *)&(args_info->coaport_arg),
				     &(args_info->coaport_orig),
				     &(args_info->coaport_given),
				     &(local_args_info.coaport_given), optarg,
				     0, "0", ARG_INT, check_ambiguity, override,
				     0, 0, "coaport", '-', additional_error))
					goto failure;
			...
			/* Allow radius disconnect from any IP.  */
				...
				if (update_arg
				    ((void *)&(args_info->coanoipcheck_flag), 0,
				     &(args_info->coanoipcheck_given),
				     &(local_args_info.coanoipcheck_given),
				     optarg, 0, 0, ARG_FLAG, check_ambiguity,
				     override, 1, 0, "coanoipcheck", '-',
				     additional_error))
					goto failure;
			...
			/* Allow all sessions when RADIUS is not available.  */
				...
				if (update_arg
				    ((void *)&(args_info->noradallow_flag), 0,
				     &(args_info->noradallow_given),
				     &(local_args_info.noradallow_given),
				     optarg, 0, 0, ARG_FLAG, check_ambiguity,
				     override, 1, 0, "noradallow", '-',
				     additional_error))
					goto failure;
			...
			/* Proxy IP address to listen on.  */
				...
				if (update_arg
				    ((void *)&(args_info->proxylisten_arg),
				     &(args_info->proxylisten_orig),
				     &(args_info->proxylisten_given),
				     &(local_args_info.proxylisten_given),
				     optarg, 0, 0, ARG_STRING, check_ambiguity,
				     override, 0, 0, "proxylisten", '-',
				     additional_error))
					goto failure;
			...
			/* Proxy UDP port to listen on (0 is off).  */
				...
				if (update_arg
				    ((void *)&(args_info->proxyport_arg),
				     &(args_info->proxyport_orig),
				     &(args_info->proxyport_given),
				     &(local_args_info.proxyport_given), optarg,
				     0, "0", ARG_INT, check_ambiguity, override,
				     0, 0, "proxyport", '-', additional_error))
					goto failure;
			...
			/* IP address of proxy client(s).  */
				...
				if (update_arg
				    ((void *)&(args_info->proxyclient_arg),
				     &(args_info->proxyclient_orig),
				     &(args_info->proxyclient_given),
				     &(local_args_info.proxyclient_given),
				     optarg, 0, 0, ARG_STRING, check_ambiguity,
				     override, 0, 0, "proxyclient", '-',
				     additional_error))
					goto failure;
			...
			/* Radius proxy shared secret.  */
				...
				if (update_arg
				    ((void *)&(args_info->proxysecret_arg),
				     &(args_info->proxysecret_orig),
				     &(args_info->proxysecret_given),
				     &(local_args_info.proxysecret_given),
				     optarg, 0, 0, ARG_STRING, check_ambiguity,
				     override, 0, 0, "proxysecret", '-',
				     additional_error))
					goto failure;
			...
			/* Auto-accept non-EAP requests on proxy port.  */
				...
				if (update_arg
				    ((void *)&(args_info->proxymacaccept_flag),
				     0, &(args_info->proxymacaccept_given),
				     &(local_args_info.proxymacaccept_given),
				     optarg, 0, 0, ARG_FLAG, check_ambiguity,
				     override, 1, 0, "proxymacaccept", '-',
				     additional_error))
					goto failure;
			...
			/* Proxy through to chilli RADIUS accounting packets.  */
				...
				if (update_arg
				    ((void *)&(args_info->proxyonacct_flag), 0,
				     &(args_info->proxyonacct_given),
				     &(local_args_info.proxyonacct_given),
				     optarg, 0, 0, ARG_FLAG, check_ambiguity,
				     override, 1, 0, "proxyonacct", '-',
				     additional_error))
					goto failure;
			...
			/* Local Ethernet interface.  */
				...
				if (update_arg((void *)&(args_info->dhcpif_arg),
					       &(args_info->dhcpif_orig),
					       &(args_info->dhcpif_given),
					       &(local_args_info.dhcpif_given),
					       optarg, 0, 0, ARG_STRING,
					       check_ambiguity, override, 0, 0,
					       "dhcpif", '-', additional_error))
					goto failure;
			...
			/* DHCP Interface MAC Address.  */
				...
				if (update_arg
				    ((void *)&(args_info->dhcpmac_arg),
				     &(args_info->dhcpmac_orig),
				     &(args_info->dhcpmac_given),
				     &(local_args_info.dhcpmac_given), optarg,
				     0, 0, ARG_STRING, check_ambiguity,
				     override, 0, 0, "dhcpmac", '-',
				     additional_error))
					goto failure;
			...
			/* Option to have dhcpif configured with dhcpmac.  */
				...
				if (update_arg
				    ((void *)&(args_info->dhcpmacset_flag), 0,
				     &(args_info->dhcpmacset_given),
				     &(local_args_info.dhcpmacset_given),
				     optarg, 0, 0, ARG_FLAG, check_ambiguity,
				     override, 1, 0, "dhcpmacset", '-',
				     additional_error))
					goto failure;
			...
			/* Next Hop MAC address.  */
				...
				if (update_arg
				    ((void *)&(args_info->nexthop_arg),
				     &(args_info->nexthop_orig),
				     &(args_info->nexthop_given),
				     &(local_args_info.nexthop_given), optarg,
				     0, 0, ARG_STRING, check_ambiguity,
				     override, 0, 0, "nexthop", '-',
				     additional_error))
					goto failure;
			...
			/* Map certain DHCP options to RADIUS attributes.  */
				...
				if (update_arg
				    ((void *)&(args_info->dhcpradius_flag), 0,
				     &(args_info->dhcpradius_given),
				     &(local_args_info.dhcpradius_given),
				     optarg, 0, 0, ARG_FLAG, check_ambiguity,
				     override, 1, 0, "dhcpradius", '-',
				     additional_error))
					goto failure;
			...
			/* DHCP gateway addresss for relay.  */
				...
				if (update_arg
				    ((void *)&(args_info->dhcpgateway_arg),
				     &(args_info->dhcpgateway_orig),
				     &(args_info->dhcpgateway_given),
				     &(local_args_info.dhcpgateway_given),
				     optarg, 0, 0, ARG_STRING, check_ambiguity,
				     override, 0, 0, "dhcpgateway", '-',
				     additional_error))
					goto failure;
			...
			/* DHCP gateway port for relay.  */
				...
				if (update_arg
				    ((void *)&(args_info->dhcpgatewayport_arg),
				     &(args_info->dhcpgatewayport_orig),
				     &(args_info->dhcpgatewayport_given),
				     &(local_args_info.dhcpgatewayport_given),
				     optarg, 0, "67", ARG_INT, check_ambiguity,
				     override, 0, 0, "dhcpgatewayport", '-',
				     additional_error))
					goto failure;
			...
			/* DHCP relay agent IP addresss (default uamlisten).  */
				...
				if (update_arg
				    ((void *)&(args_info->dhcprelayagent_arg),
				     &(args_info->dhcprelayagent_orig),
				     &(args_info->dhcprelayagent_given),
				     &(local_args_info.dhcprelayagent_given),
				     optarg, 0, 0, ARG_STRING, check_ambiguity,
				     override, 0, 0, "dhcprelayagent", '-',
				     additional_error))
					goto failure;
			...
			/* Lease time to allocate to clients.  */
				...
				if (update_arg((void *)&(args_info->lease_arg),
					       &(args_info->lease_orig),
					       &(args_info->lease_given),
					       &(local_args_info.lease_given),
					       optarg, 0, "600", ARG_INT,
					       check_ambiguity, override, 0, 0,
					       "lease", '-', additional_error))
					goto failure;
			...
			/* Lease grace period time before removal.  */
				...
				if (update_arg
				    ((void *)&(args_info->leaseplus_arg),
				     &(args_info->leaseplus_orig),
				     &(args_info->leaseplus_given),
				     &(local_args_info.leaseplus_given), optarg,
				     0, "60", ARG_INT, check_ambiguity,
				     override, 0, 0, "leaseplus", '-',
				     additional_error))
					goto failure;
			...
			/* Setup clients for /32 network.  */
				...
				if (update_arg
				    ((void *)&(args_info->noc2c_flag), 0,
				     &(args_info->noc2c_given),
				     &(local_args_info.noc2c_given), optarg, 0,
				     0, ARG_FLAG, check_ambiguity, override, 1,
				     0, "noc2c", '-', additional_error))
					goto failure;
			...
			/* Enable IEEE 802.1x authentication.  */
				...
				if (update_arg
				    ((void *)&(args_info->eapolenable_flag), 0,
				     &(args_info->eapolenable_given),
				     &(local_args_info.eapolenable_given),
				     optarg, 0, 0, ARG_FLAG, check_ambiguity,
				     override, 1, 0, "eapolenable", '-',
				     additional_error))
					goto failure;
			...
			/* URL of authentication web server.  */
				...
				if (update_arg
				    ((void *)&(args_info->uamserver_arg),
				     &(args_info->uamserver_orig),
				     &(args_info->uamserver_given),
				     &(local_args_info.uamserver_given), optarg,
				     0, 0, ARG_STRING, check_ambiguity,
				     override, 0, 0, "uamserver", '-',
				     additional_error))
					goto failure;
			...
			/* URL of homepage to redirect unauthenticated users to.  */
				...
				if (update_arg
				    ((void *)&(args_info->uamhomepage_arg),
				     &(args_info->uamhomepage_orig),
				     &(args_info->uamhomepage_given),
				     &(local_args_info.uamhomepage_given),
				     optarg, 0, 0, ARG_STRING, check_ambiguity,
				     override, 0, 0, "uamhomepage", '-',
				     additional_error))
					goto failure;
			...
			/* Shared secret between uamserver and chilli.  */
				...
				if (update_arg
				    ((void *)&(args_info->uamsecret_arg),
				     &(args_info->uamsecret_orig),
				     &(args_info->uamsecret_given),
				     &(local_args_info.uamsecret_given), optarg,
				     0, 0, ARG_STRING, check_ambiguity,
				     override, 0, 0, "uamsecret", '-',
				     additional_error))
					goto failure;
			...
			/* IP address to listen to for authentication requests.  */
				...
				if (update_arg
				    ((void *)&(args_info->uamlisten_arg),
				     &(args_info->uamlisten_orig),
				     &(args_info->uamlisten_given),
				     &(local_args_info.uamlisten_given), optarg,
				     0, 0, ARG_STRING, check_ambiguity,
				     override, 0, 0, "uamlisten", '-',
				     additional_error))
					goto failure;
			...
			/* IP address for DHCP default gateway (defaults to uamlisten).  */
				...
				if (update_arg
				    ((void *)&(args_info->dhcplisten_arg),
				     &(args_info->dhcplisten_orig),
				     &(args_info->dhcplisten_given),
				     &(local_args_info.dhcplisten_given),
				     optarg, 0, 0, ARG_STRING, check_ambiguity,
				     override, 0, 0, "dhcplisten", '-',
				     additional_error))
					goto failure;
			...
			/* TCP port to bind to for authentication requests.  */
				...
				if (update_arg
				    ((void *)&(args_info->uamport_arg),
				     &(args_info->uamport_orig),
				     &(args_info->uamport_given),
				     &(local_args_info.uamport_given), optarg,
				     0, "3990", ARG_INT, check_ambiguity,
				     override, 0, 0, "uamport", '-',
				     additional_error))
					goto failure;
			...
			/* TCP port to bind to for UAM UI requests.  */
				...
				if (update_arg
				    ((void *)&(args_info->uamuiport_arg),
				     &(args_info->uamuiport_orig),
				     &(args_info->uamuiport_given),
				     &(local_args_info.uamuiport_given), optarg,
				     0, "3991", ARG_INT, check_ambiguity,
				     override, 0, 0, "uamuiport", '-',
				     additional_error))
					goto failure;
			...
			/* DNS TTL to use (rewrite) when query matches a uamdomain.  */
				...
				if (update_arg
				    ((void *)&(args_info->uamdomainttl_arg),
				     &(args_info->uamdomainttl_orig),
				     &(args_info->uamdomainttl_given),
				     &(local_args_info.uamdomainttl_given),
				     optarg, 0, "60", ARG_INT, check_ambiguity,
				     override, 0, 0, "uamdomainttl", '-',
				     additional_error))
					goto failure;
			...
			/* Allow client to use any DNS server.  */
				...
				if (update_arg
				    ((void *)&(args_info->uamanydns_flag), 0,
				     &(args_info->uamanydns_given),
				     &(local_args_info.uamanydns_given), optarg,
				     0, 0, ARG_FLAG, check_ambiguity, override,
				     1, 0, "uamanydns", '-', additional_error))
					goto failure;
			...
			/* Allow client to use any IP Address.  */
				...
				if (update_arg
				    ((void *)&(args_info->uamanyip_flag), 0,
				     &(args_info->uamanyip_given),
				     &(local_args_info.uamanyip_given), optarg,
				     0, 0, ARG_FLAG, check_ambiguity, override,
				     1, 0, "uamanyip", '-', additional_error))
					goto failure;
			...
			/* Source NAT clients using anyip to an IP of dynip pool.  */
				...
				if (update_arg
				    ((void *)&(args_info->uamnatanyip_flag), 0,
				     &(args_info->uamnatanyip_given),
				     &(local_args_info.uamnatanyip_given),
				     optarg, 0, 0, ARG_FLAG, check_ambiguity,
				     override, 1, 0, "uamnatanyip", '-',
				     additional_error))
					goto failure;
			...
			/* A specific WISPr login url to be used.  */
				...
				if (update_arg
				    ((void *)&(args_info->wisprlogin_arg),
				     &(args_info->wisprlogin_orig),
				     &(args_info->wisprlogin_given),
				     &(local_args_info.wisprlogin_given),
				     optarg, 0, 0, ARG_STRING, check_ambiguity,
				     override, 0, 0, "wisprlogin", '-',
				     additional_error))
					goto failure;
			...
			/* Do not return to the UAM server on success, original url instead.  */
				...
				if (update_arg
				    ((void *)&(args_info->nouamsuccess_flag), 0,
				     &(args_info->nouamsuccess_given),
				     &(local_args_info.nouamsuccess_given),
				     optarg, 0, 0, ARG_FLAG, check_ambiguity,
				     override, 1, 0, "nouamsuccess", '-',
				     additional_error))
					goto failure;
			...
			/* Do not offer WISPr 1.0 XML.  */
				...
				if (update_arg
				    ((void *)&(args_info->nowispr1_flag), 0,
				     &(args_info->nowispr1_given),
				     &(local_args_info.nowispr1_given), optarg,
				     0, 0, ARG_FLAG, check_ambiguity, override,
				     1, 0, "nowispr1", '-', additional_error))
					goto failure;
			...
			/* Do not offer WISPr 2.0 XML.  */
				...
				if (update_arg
				    ((void *)&(args_info->nowispr2_flag), 0,
				     &(args_info->nowispr2_given),
				     &(local_args_info.nowispr2_given), optarg,
				     0, 0, ARG_FLAG, check_ambiguity, override,
				     1, 0, "nowispr2", '-', additional_error))
					goto failure;
			...
			/* HTTP Auto-Logout IP Address.  */
				...
				if (update_arg
				    ((void *)&(args_info->uamlogoutip_arg),
				     &(args_info->uamlogoutip_orig),
				     &(args_info->uamlogoutip_given),
				     &(local_args_info.uamlogoutip_given),
				     optarg, 0, "1.0.0.0", ARG_STRING,
				     check_ambiguity, override, 0, 0,
				     "uamlogoutip", '-', additional_error))
					goto failure;
			...
			/* Special IP Address aliased (redirect) to uamlisten/uamport.  */
				...
				if (update_arg
				    ((void *)&(args_info->uamaliasip_arg),
				     &(args_info->uamaliasip_orig),
				     &(args_info->uamaliasip_given),
				     &(local_args_info.uamaliasip_given),
				     optarg, 0, "1.0.0.1", ARG_STRING,
				     check_ambiguity, override, 0, 0,
				     "uamaliasip", '-', additional_error))
					goto failure;
			...
			/* Special simple hostname (no dots) to be resolved to uamaliasip.  */
				...
				if (update_arg
				    ((void *)&(args_info->uamaliasname_arg),
				     &(args_info->uamaliasname_orig),
				     &(args_info->uamaliasname_given),
				     &(local_args_info.uamaliasname_given),
				     optarg, 0, 0, ARG_STRING, check_ambiguity,
				     override, 0, 0, "uamaliasname", '-',
				     additional_error))
					goto failure;
			...
			/* Special simple hostname (no dots) to be resolved to uamlisten.  */
				...
				if (update_arg
				    ((void *)&(args_info->uamhostname_arg),
				     &(args_info->uamhostname_orig),
				     &(args_info->uamhostname_given),
				     &(local_args_info.uamhostname_given),
				     optarg, 0, 0, ARG_STRING, check_ambiguity,
				     override, 0, 0, "uamhostname", '-',
				     additional_error))
					goto failure;
			...
			/* UAM AAA URL specifying the URL to use for the Chilli HTTP AAA.  */
				...
				if (update_arg
				    ((void *)&(args_info->uamaaaurl_arg),
				     &(args_info->uamaaaurl_orig),
				     &(args_info->uamaaaurl_given),
				     &(local_args_info.uamaaaurl_given), optarg,
				     0, 0, ARG_STRING, check_ambiguity,
				     override, 0, 0, "uamaaaurl", '-',
				     additional_error))
					goto failure;
			...
			/* Option to consider all hostnames in domain as local.  */
				...
				if (update_arg
				    ((void *)&(args_info->domaindnslocal_flag),
				     0, &(args_info->domaindnslocal_given),
				     &(local_args_info.domaindnslocal_given),
				     optarg, 0, 0, ARG_FLAG, check_ambiguity,
				     override, 1, 0, "domaindnslocal", '-',
				     additional_error))
					goto failure;
			...
			/* Use RadSec tunning (requires SSL; not compatible with uamaaaurl).  */
				...
				if (update_arg
				    ((void *)&(args_info->radsec_flag), 0,
				     &(args_info->radsec_given),
				     &(local_args_info.radsec_given), optarg, 0,
				     0, ARG_FLAG, check_ambiguity, override, 1,
				     0, "radsec", '-', additional_error))
					goto failure;
			...
			/* Default session-timeout if not returned by RADIUS.  */
				...
				if (update_arg
				    ((void *)
				     &(args_info->defsessiontimeout_arg),
				     &(args_info->defsessiontimeout_orig),
				     &(args_info->defsessiontimeout_given),
				     &(local_args_info.defsessiontimeout_given),
				     optarg, 0, "0", ARG_LONG, check_ambiguity,
				     override, 0, 0, "defsessiontimeout", '-',
				     additional_error))
					goto failure;
			...
			/* Default idle-timeout if not returned by RADIUS.  */
				...
				if (update_arg
				    ((void *)&(args_info->defidletimeout_arg),
				     &(args_info->defidletimeout_orig),
				     &(args_info->defidletimeout_given),
				     &(local_args_info.defidletimeout_given),
				     optarg, 0, "0", ARG_INT, check_ambiguity,
				     override, 0, 0, "defidletimeout", '-',
				     additional_error))
					goto failure;
			...
			/* Default WISPr-Bandwidth-Max-Down if not returned by RADIUS.  */
				 ...
				 (long_options[option_index].name,
				  "defbandwidthmaxdown") == 0) {

				if (update_arg
				    ((void *)
				     &(args_info->defbandwidthmaxdown_arg),
				     &(args_info->defbandwidthmaxdown_orig),
				     &(args_info->defbandwidthmaxdown_given),
				     &(local_args_info.
				       defbandwidthmaxdown_given), optarg, 0,
				     "0", ARG_LONG, check_ambiguity, override,
				     0, 0, "defbandwidthmaxdown", '-',
				     additional_error))
					goto failure;
			...
			/* Default WISPr-Bandwidth-Max-Up if not returned by RADIUS.  */
				...
				if (update_arg
				    ((void *)
				     &(args_info->defbandwidthmaxup_arg),
				     &(args_info->defbandwidthmaxup_orig),
				     &(args_info->defbandwidthmaxup_given),
				     &(local_args_info.defbandwidthmaxup_given),
				     optarg, 0, "0", ARG_LONG, check_ambiguity,
				     override, 0, 0, "defbandwidthmaxup", '-',
				     additional_error))
					goto failure;
			...
			/* Default interim-interval for accounting if not returned by RADIUS.  */
				 ...
				 (long_options[option_index].name,
				  "definteriminterval") == 0) {

				if (update_arg
				    ((void *)
				     &(args_info->definteriminterval_arg),
				     &(args_info->definteriminterval_orig),
				     &(args_info->definteriminterval_given),
				     &(local_args_info.
				       definteriminterval_given), optarg, 0,
				     "300", ARG_INT, check_ambiguity, override,
				     0, 0, "definteriminterval", '-',
				     additional_error))
					goto failure;
			...
			/* Define the up-bound 'leaky bucket' size.  */
				...
				if (update_arg
				    ((void *)&(args_info->bwbucketupsize_arg),
				     &(args_info->bwbucketupsize_orig),
				     &(args_info->bwbucketupsize_given),
				     &(local_args_info.bwbucketupsize_given),
				     optarg, 0, "0", ARG_INT, check_ambiguity,
				     override, 0, 0, "bwbucketupsize", '-',
				     additional_error))
					goto failure;
			...
			/* Define the down-bound 'leaky bucket' size.  */
				...
				if (update_arg
				    ((void *)&(args_info->bwbucketdnsize_arg),
				     &(args_info->bwbucketdnsize_orig),
				     &(args_info->bwbucketdnsize_given),
				     &(local_args_info.bwbucketdnsize_given),
				     optarg, 0, "0", ARG_INT, check_ambiguity,
				     override, 0, 0, "bwbucketdnsize", '-',
				     additional_error))
					goto failure;
			...
			/* Define the minimum 'leaky bucket' size.  */
				...
				if (update_arg
				    ((void *)&(args_info->bwbucketminsize_arg),
				     &(args_info->bwbucketminsize_orig),
				     &(args_info->bwbucketminsize_given),
				     &(local_args_info.bwbucketminsize_given),
				     optarg, 0, "0", ARG_INT, check_ambiguity,
				     override, 0, 0, "bwbucketminsize", '-',
				     additional_error))
					goto failure;
			...
			/* Authenticate based on MAC address.  */
				...
				if (update_arg
				    ((void *)&(args_info->macauth_flag), 0,
				     &(args_info->macauth_given),
				     &(local_args_info.macauth_given), optarg,
				     0, 0, ARG_FLAG, check_ambiguity, override,
				     1, 0, "macauth", '-', additional_error))
					goto failure;
			...
			/* Re-Authenticate based on MAC address for every initial URL redirection.  */
				...
				if (update_arg
				    ((void *)&(args_info->macreauth_flag), 0,
				     &(args_info->macreauth_given),
				     &(local_args_info.macreauth_given), optarg,
				     0, 0, ARG_FLAG, check_ambiguity, override,
				     1, 0, "macreauth", '-', additional_error))
					goto failure;
			...
			/* Deny access (even UAM) to MAC addresses given Access-Reject.  */
				...
				if (update_arg
				    ((void *)&(args_info->macauthdeny_flag), 0,
				     &(args_info->macauthdeny_given),
				     &(local_args_info.macauthdeny_given),
				     optarg, 0, 0, ARG_FLAG, check_ambiguity,
				     override, 1, 0, "macauthdeny", '-',
				     additional_error))
					goto failure;
			...
			/* Suffix to add to the MAC address.  */
				...
				if (update_arg
				    ((void *)&(args_info->macsuffix_arg),
				     &(args_info->macsuffix_orig),
				     &(args_info->macsuffix_given),
				     &(local_args_info.macsuffix_given), optarg,
				     0, 0, ARG_STRING, check_ambiguity,
				     override, 0, 0, "macsuffix", '-',
				     additional_error))
					goto failure;
			...
			/* Password used when performing MAC authentication.  */
				...
				if (update_arg
				    ((void *)&(args_info->macpasswd_arg),
				     &(args_info->macpasswd_orig),
				     &(args_info->macpasswd_given),
				     &(local_args_info.macpasswd_given), optarg,
				     0, 0, ARG_STRING, check_ambiguity,
				     override, 0, 0, "macpasswd", '-',
				     additional_error))
					goto failure;
			...
			/* Do not use RADIUS for authenticating the macallowed.  */
				...
				if (update_arg
				    ((void *)&(args_info->macallowlocal_flag),
				     0, &(args_info->macallowlocal_given),
				     &(local_args_info.macallowlocal_given),
				     optarg, 0, 0, ARG_FLAG, check_ambiguity,
				     override, 1, 0, "macallowlocal", '-',
				     additional_error))
					goto failure;
			...
			/* Be strict about MAC Auth (no DHCP reply until we get RADIUS reply).  */
				...
				if (update_arg
				    ((void *)&(args_info->strictmacauth_flag),
				     0, &(args_info->strictmacauth_given),
				     &(local_args_info.strictmacauth_given),
				     optarg, 0, 0, ARG_FLAG, check_ambiguity,
				     override, 1, 0, "strictmacauth", '-',
				     additional_error))
					goto failure;
			...
			/* Be strict about only allocating dyn-pool from DHCP.  */
				...
				if (update_arg
				    ((void *)&(args_info->strictdhcp_flag), 0,
				     &(args_info->strictdhcp_given),
				     &(local_args_info.strictdhcp_given),
				     optarg, 0, 0, ARG_FLAG, check_ambiguity,
				     override, 1, 0, "strictdhcp", '-',
				     additional_error))
					goto failure;
			...
			/* Local content served by chilli (for splash page, etc).  */
				...
				if (update_arg((void *)&(args_info->wwwdir_arg),
					       &(args_info->wwwdir_orig),
					       &(args_info->wwwdir_given),
					       &(local_args_info.wwwdir_given),
					       optarg, 0, 0, ARG_STRING,
					       check_ambiguity, override, 0, 0,
					       "wwwdir", '-', additional_error))
					goto failure;
			...
			/* Script binary (such as haserl) for simple web programming.  */
				...
				if (update_arg((void *)&(args_info->wwwbin_arg),
					       &(args_info->wwwbin_orig),
					       &(args_info->wwwbin_given),
					       &(local_args_info.wwwbin_given),
					       optarg, 0, 0, ARG_STRING,
					       check_ambiguity, override, 0, 0,
					       "wwwbin", '-', additional_error))
					goto failure;
			...
			/* Program in inetd style to handle all uam requests.  */
				...
				if (update_arg((void *)&(args_info->uamui_arg),
					       &(args_info->uamui_orig),
					       &(args_info->uamui_given),
					       &(local_args_info.uamui_given),
					       optarg, 0, 0, ARG_STRING,
					       check_ambiguity, override, 0, 0,
					       "uamui", '-', additional_error))
					goto failure;
			...
			/* RADIUS administrative user login username.  */
				...
				if (update_arg
				    ((void *)&(args_info->adminuser_arg),
				     &(args_info->adminuser_orig),
				     &(args_info->adminuser_given),
				     &(local_args_info.adminuser_given), optarg,
				     0, 0, ARG_STRING, check_ambiguity,
				     override, 0, 0, "adminuser", '-',
				     additional_error))
					goto failure;
			...
			/* RADIUS administrative user login password.  */
				...
				if (update_arg
				    ((void *)&(args_info->adminpasswd_arg),
				     &(args_info->adminpasswd_orig),
				     &(args_info->adminpasswd_given),
				     &(local_args_info.adminpasswd_given),
				     optarg, 0, 0, ARG_STRING, check_ambiguity,
				     override, 0, 0, "adminpasswd", '-',
				     additional_error))
					goto failure;
			...
			/* File for administrative user ChilliSpot-Config settings.  */
				...
				if (update_arg
				    ((void *)&(args_info->adminupdatefile_arg),
				     &(args_info->adminupdatefile_orig),
				     &(args_info->adminupdatefile_given),
				     &(local_args_info.adminupdatefile_given),
				     optarg, 0, 0, ARG_STRING, check_ambiguity,
				     override, 0, 0, "adminupdatefile", '-',
				     additional_error))
					goto failure;
			...
			/* File to update with routing settings.  */
				...
				if (update_arg
				    ((void *)&(args_info->rtmonfile_arg),
				     &(args_info->rtmonfile_orig),
				     &(args_info->rtmonfile_given),
				     &(local_args_info.rtmonfile_given), optarg,
				     0, 0, ARG_STRING, check_ambiguity,
				     override, 0, 0, "rtmonfile", '-',
				     additional_error))
					goto failure;
			...
			/* File containing a mapping of MAC addresses to static IP addresses.  */
				...
				if (update_arg((void *)&(args_info->ethers_arg),
					       &(args_info->ethers_orig),
					       &(args_info->ethers_given),
					       &(local_args_info.ethers_given),
					       optarg, 0, 0, ARG_STRING,
					       check_ambiguity, override, 0, 0,
					       "ethers", '-', additional_error))
					goto failure;
			...
			/* Unique MAC address of the NAS (called-station-id).  */
				...
				if (update_arg((void *)&(args_info->nasmac_arg),
					       ...
					       &(args_info->nasmac_given),
					       &(local_args_info.nasmac_given),
					       optarg, 0, 0, ARG_STRING,
					       check_ambiguity, override, 0, 0,
					       "nasmac", '-', additional_error))
					goto failure;
			...
			/* Unique IP address of the NAS (nas-ip-address).  */
				...
				if (update_arg((void *)&(args_info->nasip_arg),
					       &(args_info->nasip_orig),
					       &(args_info->nasip_given),
					       &(local_args_info.nasip_given),
					       optarg, 0, 0, ARG_STRING,
					       check_ambiguity, override, 0, 0,
					       "nasip", '-', additional_error))
					goto failure;

			}
			/* SSID of the session.  */
			else if (strcmp(long_options[option_index].name, "ssid")
				 == 0) {

				if (update_arg((void *)&(args_info->ssid_arg),
					       &(args_info->ssid_orig),
					       &(args_info->ssid_given),
					       &(local_args_info.ssid_given),
					       optarg, 0, 0, ARG_STRING,
					       check_ambiguity, override, 0, 0,
					       "ssid", '-', additional_error))
					goto failure;

			}
			/* VLAN of the session.  */
			else if (strcmp(long_options[option_index].name, "vlan")
				 == 0) {

				if (update_arg((void *)&(args_info->vlan_arg),
					       &(args_info->vlan_orig),
					       &(args_info->vlan_given),
					       &(local_args_info.vlan_given),
					       optarg, 0, 0, ARG_STRING,
					       check_ambiguity, override, 0, 0,
					       "vlan", '-', additional_error))
					goto failure;
			...
			/* Support 802.1Q VLAN tagging.  */
				...
				if (update_arg
				    ((void *)&(args_info->ieee8021q_flag), 0,
				     &(args_info->ieee8021q_given),
				     &(local_args_info.ieee8021q_given), optarg,
				     0, 0, ARG_FLAG, check_ambiguity, override,
				     1, 0, "ieee8021q", '-', additional_error))
					goto failure;
			...
			/* Support 802.1Q VLAN tagged traffic only.  */
				...
				if (update_arg
				    ((void *)&(args_info->only8021q_flag), 0,
				     &(args_info->only8021q_given),
				     &(local_args_info.only8021q_given), optarg,
				     0, 0, ARG_FLAG, check_ambiguity, override,
				     1, 0, "only8021q", '-', additional_error))
					goto failure;
			...
			/* path to the command unix socket.  */
				...
				if (update_arg
				    ((void *)&(args_info->cmdsocket_arg),
				     &(args_info->cmdsocket_orig),
				     &(args_info->cmdsocket_given),
				     &(local_args_info.cmdsocket_given), optarg,
				     0, 0, ARG_STRING, check_ambiguity,
				     override, 0, 0, "cmdsocket", '-',
				     additional_error))
					goto failure;
			...
			/* Port of command socket. Only used if cmdsocket is not defined..  */
				...
				if (update_arg
				    ((void *)&(args_info->cmdsocketport_arg),
				     &(args_info->cmdsocketport_orig),
				     &(args_info->cmdsocketport_given),
				     &(local_args_info.cmdsocketport_given),
				     optarg, 0, "42424", ARG_INT,
				     check_ambiguity, override, 0, 0,
				     "cmdsocketport", '-', additional_error))
					goto failure;
			...
			/* Turn on the sending of ChilliSpot-OriginalURL in Access-Request.  */
				...
				if (update_arg
				    ((void *)
				     &(args_info->radiusoriginalurl_flag), 0,
				     &(args_info->radiusoriginalurl_given),
				     &(local_args_info.radiusoriginalurl_given),
				     optarg, 0, 0, ARG_FLAG, check_ambiguity,
				     override, 1, 0, "radiusoriginalurl", '-',
				     additional_error))
					goto failure;
			...
			/* Swap the meaning of input/output octets/packets.  */
				...
				if (update_arg
				    ((void *)&(args_info->swapoctets_flag), 0,
				     &(args_info->swapoctets_given),
				     &(local_args_info.swapoctets_given),
				     optarg, 0, 0, ARG_FLAG, check_ambiguity,
				     override, 1, 0, "swapoctets", '-',
				     additional_error))
					goto failure;
			...
			/* Use the status file to keep track of sessions.  */
				...
				if (update_arg
				    ((void *)&(args_info->usestatusfile_arg),
				     &(args_info->usestatusfile_orig),
				     &(args_info->usestatusfile_given),
				     &(local_args_info.usestatusfile_given),
				     optarg, 0, 0, ARG_STRING, check_ambiguity,
				     override, 0, 0, "usestatusfile", '-',
				     additional_error))
					goto failure;
			...
			/* Aggressively save the status of sessions to status file.  */
				...
				if (update_arg
				    ((void *)&(args_info->statusfilesave_flag),
				     0, &(args_info->statusfilesave_given),
				     &(local_args_info.statusfilesave_given),
				     optarg, 0, 0, ARG_FLAG, check_ambiguity,
				     override, 1, 0, "statusfilesave", '-',
				     additional_error))
					goto failure;
			...
			/* File keep 'Local' usernames and passwords.  */
				...
				if (update_arg
				    ((void *)&(args_info->localusers_arg),
				     &(args_info->localusers_orig),
				     &(args_info->localusers_given),
				     &(local_args_info.localusers_given),
				     optarg, 0, 0, ARG_STRING, check_ambiguity,
				     override, 0, 0, "localusers", '-',
				     additional_error))
					goto failure;
			...
			/* IP of an upstream transparent proxy.  */
				...
				if (update_arg
				    ((void *)&(args_info->postauthproxy_arg),
				     &(args_info->postauthproxy_orig),
				     &(args_info->postauthproxy_given),
				     &(local_args_info.postauthproxy_given),
				     optarg, 0, 0, ARG_STRING, check_ambiguity,
				     override, 0, 0, "postauthproxy", '-',
				     additional_error))
					goto failure;
			...
			/* Port of an upstream transparent proxy.  */
				...
				if (update_arg
				    ((void *)
				     &(args_info->postauthproxyport_arg),
				     &(args_info->postauthproxyport_orig),
				     &(args_info->postauthproxyport_given),
				     &(local_args_info.postauthproxyport_given),
				     optarg, 0, "0", ARG_INT, check_ambiguity,
				     override, 0, 0, "postauthproxyport", '-',
				     additional_error))
					goto failure;
			...
			/* Allow WPA 'Guest' access.  */
				...
				if (update_arg
				    ((void *)&(args_info->wpaguests_flag), 0,
				     &(args_info->wpaguests_given),
				     &(local_args_info.wpaguests_given), optarg,
				     0, 0, ARG_FLAG, check_ambiguity, override,
				     1, 0, "wpaguests", '-', additional_error))
					goto failure;
			...
			/* Allow OpenID authentication.  */
				...
				if (update_arg
				    ((void *)&(args_info->openidauth_flag), 0,
				     &(args_info->openidauth_given),
				     &(local_args_info.openidauth_given),
				     optarg, 0, 0, ARG_FLAG, check_ambiguity,
				     override, 1, 0, "openidauth", '-',
				     additional_error))
					goto failure;
			...
			/* Always allow 'PAP' authentication (depreciated; always on).  */
				...
				if (update_arg
				    ((void *)&(args_info->papalwaysok_flag), 0,
				     &(args_info->papalwaysok_given),
				     &(local_args_info.papalwaysok_given),
				     optarg, 0, 0, ARG_FLAG, check_ambiguity,
				     override, 1, 0, "papalwaysok", '-',
				     additional_error))
					goto failure;
			...
			/* Use MSCHAPv2 authentication where possible.  */
				...
				if (update_arg
				    ((void *)&(args_info->mschapv2_flag), 0,
				     &(args_info->mschapv2_given),
				     &(local_args_info.mschapv2_given), optarg,
				     0, 0, ARG_FLAG, check_ambiguity, override,
				     1, 0, "mschapv2", '-', additional_error))
					goto failure;
			...
			/* Use ChilliSpot XML in WISPr blocks.  */
				...
				if (update_arg
				    ((void *)&(args_info->chillixml_flag), 0,
				     &(args_info->chillixml_given),
				     &(local_args_info.chillixml_given), optarg,
				     0, 0, ARG_FLAG, check_ambiguity, override,
				     1, 0, "chillixml", '-', additional_error))
					goto failure;
			...
			/* Allow updating of session attributes in Accounting-Response.  */
				...
				if (update_arg
				    ((void *)&(args_info->acctupdate_flag), 0,
				     &(args_info->acctupdate_given),
				     &(local_args_info.acctupdate_given),
				     optarg, 0, 0, ARG_FLAG, check_ambiguity,
				     override, 1, 0, "acctupdate", '-',
				     additional_error))
					goto failure;
			...
			/* Inspect DNS packets and drop responses with any non- A, CNAME, SOA, or MX records (to prevent dns tunnels).  */
				...
				if (update_arg
				    ((void *)&(args_info->dnsparanoia_flag), 0,
				     &(args_info->dnsparanoia_given),
				     &(local_args_info.dnsparanoia_given),
				     optarg, 0, 0, ARG_FLAG, check_ambiguity,
				     override, 1, 0, "dnsparanoia", '-',
				     additional_error))
					goto failure;
			...
			/* Keep sessions 'alive' after a restart of the server.  */
				...
				if (update_arg
				    ((void *)&(args_info->seskeepalive_flag), 0,
				     &(args_info->seskeepalive_given),
				     &(local_args_info.seskeepalive_given),
				     optarg, 0, 0, ARG_FLAG, check_ambiguity,
				     override, 1, 0, "seskeepalive", '-',
				     additional_error))
					goto failure;
			...
			/* Use a TAP instead of TUN (linux only).  */
				...
				if (update_arg
				    ((void *)&(args_info->usetap_flag), 0,
				     &(args_info->usetap_given),
				     &(local_args_info.usetap_given), optarg, 0,
				     0, ARG_FLAG, check_ambiguity, override, 1,
				     0, "usetap", '-', additional_error))
					goto failure;
			...
			/* Do not create arp table entries in when using TAP..  */
				...
				if (update_arg
				    ((void *)&(args_info->noarpentries_flag), 0,
				     &(args_info->noarpentries_given),
				     &(local_args_info.noarpentries_given),
				     optarg, 0, 0, ARG_FLAG, check_ambiguity,
				     override, 1, 0, "noarpentries", '-',
				     additional_error))
					goto failure;
			...
			/* Turns on 'multi-routing' and defines default route.  */
				...
				if (update_arg
				    ((void *)&(args_info->routeif_arg),
				     &(args_info->routeif_orig),
				     &(args_info->routeif_given),
				     &(local_args_info.routeif_given), optarg,
				     0, 0, ARG_STRING, check_ambiguity,
				     override, 0, 0, "routeif", '-',
				     additional_error))
					goto failure;
			...
			/* Use Service-Type = Framed instead of Login.  */
				...
				if (update_arg
				    ((void *)&(args_info->framedservice_flag),
				     0, &(args_info->framedservice_given),
				     &(local_args_info.framedservice_given),
				     optarg, 0, 0, ARG_FLAG, check_ambiguity,
				     override, 1, 0, "framedservice", '-',
				     additional_error))
					goto failure;
			...
			/* Change TCP window size to this value to help prevent congestion.  */
				...
				if (update_arg((void *)&(args_info->tcpwin_arg),
					       &(args_info->tcpwin_orig),
					       &(args_info->tcpwin_given),
					       &(local_args_info.tcpwin_given),
					       optarg, 0, "0", ARG_INT,
					       check_ambiguity, override, 0, 0,
					       "tcpwin", '-', additional_error))
					goto failure;
			...
			/* Scale the TCP window when bandwidth shaping.  */
				...
				if (update_arg
				    ((void *)&(args_info->scalewin_flag), 0,
				     &(args_info->scalewin_given),
				     &(local_args_info.scalewin_given), optarg,
				     0, 0, ARG_FLAG, check_ambiguity, override,
				     1, 0, "scalewin", '-', additional_error))
					goto failure;
			...
			/* Change TCP maximum window size (mss) option in TCP traffic.  */
				...
				if (update_arg((void *)&(args_info->tcpmss_arg),
					       &(args_info->tcpmss_orig),
					       &(args_info->tcpmss_given),
					       &(local_args_info.tcpmss_given),
					       optarg, 0, "0", ARG_INT,
					       check_ambiguity, override, 0, 0,
					       "tcpmss", '-', additional_error))
					goto failure;
			...
			/* Maximum number of clients/subscribers.  */
				...
				if (update_arg
				    ((void *)&(args_info->maxclients_arg),
				     &(args_info->maxclients_orig),
				     &(args_info->maxclients_given),
				     &(local_args_info.maxclients_given),
				     optarg, 0, "512", ARG_INT, check_ambiguity,
				     override, 0, 0, "maxclients", '-',
				     additional_error))
					goto failure;
			...
			/* Size of DHCP/MAC hash table.  */
				...
				if (update_arg
				    ((void *)&(args_info->dhcphashsize_arg),
				     &(args_info->dhcphashsize_orig),
				     &(args_info->dhcphashsize_given),
				     &(local_args_info.dhcphashsize_given),
				     optarg, 0, "56", ARG_INT, check_ambiguity,
				     override, 0, 0, "dhcphashsize", '-',
				     additional_error))
					goto failure;
			...
			/* Size of RADIUS queue table.  */
				...
				if (update_arg
				    ((void *)&(args_info->radiusqsize_arg),
				     &(args_info->radiusqsize_orig),
				     &(args_info->radiusqsize_given),
				     &(local_args_info.radiusqsize_given),
				     optarg, 0, "0", ARG_INT, check_ambiguity,
				     override, 0, 0, "radiusqsize", '-',
				     additional_error))
					goto failure;
			...
			/* Timeout in seconds for the generated challenge.  */
				...
				if (update_arg
				    ((void *)&(args_info->challengetimeout_arg),
				     &(args_info->challengetimeout_orig),
				     &(args_info->challengetimeout_given),
				     &(local_args_info.challengetimeout_given),
				     optarg, 0, "600", ARG_INT, check_ambiguity,
				     override, 0, 0, "challengetimeout", '-',
				     additional_error))
					goto failure;
			...
			/* Timeout in seconds for challenge during login.  */
				...
				if (update_arg
				    ((void *)
				     &(args_info->challengetimeout2_arg),
				     &(args_info->challengetimeout2_orig),
				     &(args_info->challengetimeout2_given),
				     &(local_args_info.challengetimeout2_given),
				     optarg, 0, "1200", ARG_INT,
				     check_ambiguity, override, 0, 0,
				     "challengetimeout2", '-',
				     additional_error))
					goto failure;
			...
			/* Enable redir (redirection) daemon.  */
				...
				if (update_arg
				    ((void *)&(args_info->redir_flag), 0,
				     &(args_info->redir_given),
				     &(local_args_info.redir_given), optarg, 0,
				     0, ARG_FLAG, check_ambiguity, override, 1,
				     0, "redir", '-', additional_error))
					goto failure;
			...
			/* Enable redir injection.  */
				...
				if (update_arg((void *)&(args_info->inject_arg),
					       &(args_info->inject_orig),
					       &(args_info->inject_given),
					       &(local_args_info.inject_given),
					       optarg, 0, 0, ARG_STRING,
					       check_ambiguity, override, 0, 0,
					       "inject", '-', additional_error))
					goto failure;
			...
			/* Enable redir injection extended script.  */
				...
				if (update_arg
				    ((void *)&(args_info->injectext_arg),
				     &(args_info->injectext_orig),
				     &(args_info->injectext_given),
				     &(local_args_info.injectext_given), optarg,
				     0, 0, ARG_STRING, check_ambiguity,
				     override, 0, 0, "injectext", '-',
				     additional_error))
					goto failure;
			...
			/* Enable redir injection of WISPr.  */
				...
				if (update_arg
				    ((void *)&(args_info->injectwispr_flag), 0,
				     &(args_info->injectwispr_given),
				     &(local_args_info.injectwispr_given),
				     optarg, 0, 0, ARG_FLAG, check_ambiguity,
				     override, 1, 0, "injectwispr", '-',
				     additional_error))
					goto failure;
			...
			/* Send redirection URL in UAM parameters instead of HTTP redirect.  */
				...
				if (update_arg
				    ((void *)&(args_info->redirurl_flag), 0,
				     &(args_info->redirurl_given),
				     &(local_args_info.redirurl_given), optarg,
				     0, 0, ARG_FLAG, check_ambiguity, override,
				     1, 0, "redirurl", '-', additional_error))
					goto failure;
			...
			/* When using routeif, do one-to-one NAT.  */
				...
				if (update_arg
				    ((void *)&(args_info->routeonetone_flag), 0,
				     &(args_info->routeonetone_given),
				     &(local_args_info.routeonetone_given),
				     optarg, 0, 0, ARG_FLAG, check_ambiguity,
				     override, 1, 0, "routeonetone", '-',
				     additional_error))
					goto failure;
			...
			/* Do not consider walled garden for authorized session accounting.  */
				...
				if (update_arg
				    ((void *)
				     &(args_info->nousergardendata_flag), 0,
				     &(args_info->nousergardendata_given),
				     &(local_args_info.nousergardendata_given),
				     optarg, 0, 0, ARG_FLAG, check_ambiguity,
				     override, 1, 0, "nousergardendata", '-',
				     additional_error))
					goto failure;
			...
			/* Enable a RADIUS accounting session for walled garden data based on IP lease life-cycle.  */
				...
				if (update_arg
				    ((void *)&(args_info->uamgardendata_flag),
				     0, &(args_info->uamgardendata_given),
				     &(local_args_info.uamgardendata_given),
				     optarg, 0, 0, ARG_FLAG, check_ambiguity,
				     override, 1, 0, "uamgardendata", '-',
				     additional_error))
					goto failure;
			...
			/* Enable accounting for dropped 'Other' of IP session.  */
				...
				if (update_arg
				    ((void *)&(args_info->uamotherdata_flag), 0,
				     &(args_info->uamotherdata_given),
				     &(local_args_info.uamotherdata_given),
				     optarg, 0, 0, ARG_FLAG, check_ambiguity,
				     override, 1, 0, "uamotherdata", '-',
				     additional_error))
					goto failure;
			...
			/* SSL private key file in PEM format.  */
				...
				if (update_arg
				    ((void *)&(args_info->sslkeyfile_arg),
				     &(args_info->sslkeyfile_orig),
				     &(args_info->sslkeyfile_given),
				     &(local_args_info.sslkeyfile_given),
				     optarg, 0, 0, ARG_STRING, check_ambiguity,
				     override, 0, 0, "sslkeyfile", '-',
				     additional_error))
					goto failure;
			...
			/* SSL private key password.  */
				...
				if (update_arg
				    ((void *)&(args_info->sslkeypass_arg),
				     &(args_info->sslkeypass_orig),
				     &(args_info->sslkeypass_given),
				     &(local_args_info.sslkeypass_given),
				     optarg, 0, 0, ARG_STRING, check_ambiguity,
				     override, 0, 0, "sslkeypass", '-',
				     additional_error))
					goto failure;
			...
			/* SSL certificate file in PEM format.  */
				...
				if (update_arg
				    ((void *)&(args_info->sslcertfile_arg),
				     &(args_info->sslcertfile_orig),
				     &(args_info->sslcertfile_given),
				     &(local_args_info.sslcertfile_given),
				     optarg, 0, 0, ARG_STRING, check_ambiguity,
				     override, 0, 0, "sslcertfile", '-',
				     additional_error))
					goto failure;
			...
			/* SSL CA certificate file in PEM format.  */
				...
				if (update_arg
				    ((void *)&(args_info->sslcafile_arg),
				     &(args_info->sslcafile_orig),
				     &(args_info->sslcafile_given),
				     &(local_args_info.sslcafile_given), optarg,
				     0, 0, ARG_STRING, check_ambiguity,
				     override, 0, 0, "sslcafile", '-',
				     additional_error))
					goto failure;
			...
			/* The UNIX IPC Filename to use when compiled with --with-unixipc.  */
				...
				if (update_arg
				    ((void *)&(args_info->unixipc_arg),
				     &(args_info->unixipc_orig),
				     &(args_info->unixipc_given),
				     &(local_args_info.unixipc_given), optarg,
				     0, 0, ARG_STRING, check_ambiguity,
				     override, 0, 0, "unixipc", '-',
				     additional_error))
					goto failure;
			...
			/* Enable to allow a HTTP POST to the standard uamport interface.  */
				...
				if (update_arg
				    ((void *)&(args_info->uamallowpost_flag), 0,
				     &(args_info->uamallowpost_given),
				     &(local_args_info.uamallowpost_given),
				     optarg, 0, 0, ARG_FLAG, check_ambiguity,
				     override, 1, 0, "uamallowpost", '-',
				     additional_error))
					goto failure;
			...
			/* IP to use when doing nat on WAN (routeidx).  */
				...
				if (update_arg((void *)&(args_info->natip_arg),
					       &(args_info->natip_orig),
					       &(args_info->natip_given),
					       &(local_args_info.natip_given),
					       optarg, 0, 0, ARG_STRING,
					       check_ambiguity, override, 0, 0,
					       "natip", '-', additional_error))
					goto failure;
			...
			/* Port to use when oding nat on the WAN (routeidx).  */
				...
				if (update_arg
				    ((void *)&(args_info->natport_arg),
				     &(args_info->natport_orig),
				     &(args_info->natport_given),
				     &(local_args_info.natport_given), optarg,
				     0, "0", ARG_INT, check_ambiguity, override,
				     0, 0, "natport", '-', additional_error))
					goto failure;
			...
			/* Enable redirection of SSL/HTTP port (requires SSL support).  */
				...
				if (update_arg
				    ((void *)&(args_info->redirssl_flag), 0,
				     &(args_info->redirssl_given),
				     &(local_args_info.redirssl_given), optarg,
				     0, 0, ARG_FLAG, check_ambiguity, override,
				     1, 0, "redirssl", '-', additional_error))
					goto failure;
			...
			/* Enable SSL/HTTPS support on the uamuiport.  */
				...
				if (update_arg
				    ((void *)&(args_info->uamuissl_flag), 0,
				     &(args_info->uamuissl_given),
				     &(local_args_info.uamuissl_given), optarg,
				     0, 0, ARG_FLAG, check_ambiguity, override,
				     1, 0, "uamuissl", '-', additional_error))
					goto failure;
			...
			/* Log DNS requests to a file..  */
				...
				if (update_arg((void *)&(args_info->dnslog_arg),
					       &(args_info->dnslog_orig),
					       &(args_info->dnslog_given),
					       &(local_args_info.dnslog_given),
					       optarg, 0, 0, ARG_STRING,
					       check_ambiguity, override, 0, 0,
					       "dnslog", '-', additional_error))
					goto failure;
			...
			/* Binary IP White List file.  */
				...
				if (update_arg
				    ((void *)&(args_info->ipwhitelist_arg),
				     &(args_info->ipwhitelist_orig),
				     &(args_info->ipwhitelist_given),
				     &(local_args_info.ipwhitelist_given),
				     optarg, 0, 0, ARG_STRING, check_ambiguity,
				     override, 0, 0, "ipwhitelist", '-',
				     additional_error))
					goto failure;
			...
			/* Load uamdomains (regex) from file.  */
				...
				if (update_arg
				    ((void *)&(args_info->uamdomainfile_arg),
				     &(args_info->uamdomainfile_orig),
				     &(args_info->uamdomainfile_given),
				     &(local_args_info.uamdomainfile_given),
				     optarg, 0, 0, ARG_STRING, check_ambiguity,
				     override, 0, 0, "uamdomainfile", '-',
				     additional_error))
					goto failure;
			...
			/* Layer3 only.  */
				...
				if (update_arg
				    ((void *)&(args_info->layer3_flag), 0,
				     &(args_info->layer3_given),
				     &(local_args_info.layer3_given), optarg, 0,
				     0, ARG_FLAG, check_ambiguity, override, 1,
				     0, "layer3", '-', additional_error))
					goto failure;
			...
			/* Use patricia tries for walled garden lookup.  */
				...
				if (update_arg
				    ((void *)&(args_info->patricia_flag), 0,
				     &(args_info->patricia_given),
				     &(local_args_info.patricia_given), optarg,
				     0, 0, ARG_FLAG, check_ambiguity, override,
				     1, 0, "patricia", '-', additional_error))
					goto failure;
			...
			/* Send DNS query on redirect to pick of DNS based walled garden.  */
				...
				if (update_arg
				    ((void *)&(args_info->redirdnsreq_flag), 0,
				     &(args_info->redirdnsreq_given),
				     &(local_args_info.redirdnsreq_given),
				     optarg, 0, 0, ARG_FLAG, check_ambiguity,
				     override, 1, 0, "redirdnsreq", '-',
				     additional_error))
					goto failure;
			...
			/* Enable the use of the coova kernel module instance of this namem.  */
				...
				if (update_arg((void *)&(args_info->kname_arg),
					       &(args_info->kname_orig),
					       &(args_info->kname_given),
					       &(local_args_info.kname_given),
					       optarg, 0, 0, ARG_STRING,
					       check_ambiguity, override, 0, 0,
					       "kname", '-', additional_error))
					goto failure;
			...
			/* Directory for dynamically loaded modules.  */
				...
				if (update_arg((void *)&(args_info->moddir_arg),
					       &(args_info->moddir_orig),
					       &(args_info->moddir_given),
					       &(local_args_info.moddir_given),
					       optarg, 0, 0, ARG_STRING,
					       check_ambiguity, override, 0, 0,
					       "moddir", '-', additional_error))
					goto failure;
			...
			/* DHCP counted for preventing idle-timeout.  */
				...
				if (update_arg
				    ((void *)&(args_info->dhcpnotidle_flag), 0,
				     &(args_info->dhcpnotidle_given),
				     &(local_args_info.dhcpnotidle_given),
				     optarg, 0, 0, ARG_FLAG, check_ambiguity,
				     override, 1, 0, "dhcpnotidle", '-',
				     additional_error))
					goto failure;

			}
			/* Enable IPv6 support.  */
			else if (strcmp(long_options[option_index].name, "ipv6")
				 == 0) {

				if (update_arg
				    ((void *)&(args_info->ipv6_flag), 0,
				     &(args_info->ipv6_given),
				     &(local_args_info.ipv6_given), optarg, 0,
				     0, ARG_FLAG, check_ambiguity, override, 1,
				     0, "ipv6", '-', additional_error))
					goto failure;
			...
			/* Enable IPv6-Only.  */
				...
				if (update_arg
				    ((void *)&(args_info->ipv6only_flag), 0,
				     &(args_info->ipv6only_given),
				     &(local_args_info.ipv6only_given), optarg,
				     0, 0, ARG_FLAG, check_ambiguity, override,
				     1, 0, "ipv6only", '-', additional_error))
					goto failure;
	...
	update_multiple_arg((void *)&(args_info->proxylocattr_arg),
			    &(args_info->proxylocattr_orig),
			    args_info->proxylocattr_given,
			    local_args_info.proxylocattr_given, 0, ARG_STRING,
			    proxylocattr_list);
	update_multiple_arg((void *)&(args_info->moreif_arg),
			    &(args_info->moreif_orig), args_info->moreif_given,
			    local_args_info.moreif_given, 0, ARG_STRING,
			    moreif_list);
	update_multiple_arg((void *)&(args_info->uamallowed_arg),
			    &(args_info->uamallowed_orig),
			    args_info->uamallowed_given,
			    local_args_info.uamallowed_given, 0, ARG_STRING,
			    uamallowed_list);
	update_multiple_arg((void *)&(args_info->uamdomain_arg),
			    &(args_info->uamdomain_orig),
			    args_info->uamdomain_given,
			    local_args_info.uamdomain_given, 0, ARG_STRING,
			    uamdomain_list);
	update_multiple_arg((void *)&(args_info->uamregex_arg),
			    &(args_info->uamregex_orig),
			    args_info->uamregex_given,
			    local_args_info.uamregex_given, 0, ARG_STRING,
			    uamregex_list);
	update_multiple_arg((void *)&(args_info->macallowed_arg),
			    &(args_info->macallowed_orig),
			    args_info->macallowed_given,
			    local_args_info.macallowed_given, 0, ARG_STRING,
			    macallowed_list);
	update_multiple_arg((void *)&(args_info->module_arg),
			    &(args_info->module_orig), args_info->module_given,
			    local_args_info.module_given, 0, ARG_STRING,
			    module_list);
	update_multiple_arg((void *)&(args_info->dhcpopt_arg),
			    &(args_info->dhcpopt_orig),
			    args_info->dhcpopt_given,
			    local_args_info.dhcpopt_given, 0, ARG_STRING,
			    dhcpopt_list);
	update_multiple_arg((void *)&(args_info->extadmvsa_arg),
			    &(args_info->extadmvsa_orig),
			    args_info->extadmvsa_given,
			    local_args_info.extadmvsa_given, 0, ARG_STRING,
			    extadmvsa_list);
